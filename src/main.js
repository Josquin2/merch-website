...
const router = createRouter({
  ...
  routes: [
    { path: '/merch-website/', name: 'main', component: StartPage },
    { name: 'favorites', path: '/merch-website/favorites', component: Favorites },
    ...
    { name: 'cart', path: '/merch-website/cart', component: Cart },
